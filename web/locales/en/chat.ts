export const ChatEn = {
  ...
  example_create_sql_skill_query:
    'Among all districts, which district has the most valid difficult-personnel certification records?',
  ...
  db_gpt_computer: "K-ICS's Computer",
  ...
  db_gpt_thinking: 'K-ICS is thinking...',
  replay_badge: 'Replay',
  replay_page_title: 'K-ICS Conversation Replay',
  replay_page_title_with_question: '{{question}} · K-ICS Replay',
