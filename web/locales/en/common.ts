export const CommonEn = {
  ...
  data_center_desc: 'K-ICS also offers a user-friendly data center management interface for efficient data maintenance.',
  ...
  dbgpts_community: 'K-ICS Apps Community',
  community_dbgpts: 'Community K-ICS Apps',
  my_dbgpts: 'My K-ICS Apps',
  ...
  home_title: 'K-ICS AI Data Assistant',
  ...
  'request.error.network':
    'Cannot connect to K-ICS service: network unreachable (possibly CORS restriction or service not running). Please check cors_allowed_origins config and whether the service is up.',
