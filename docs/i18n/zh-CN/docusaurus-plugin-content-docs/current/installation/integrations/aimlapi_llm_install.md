...
### This section describes how to use the AI/ML API provider with K-ICS.
...
3. Use the `configs/dbgpt-proxy-aimlapi.toml` configuration when starting K-ICS.
...
### Or you can use docker/base/Dockerfile to run K-ICS with AI/ML API:
