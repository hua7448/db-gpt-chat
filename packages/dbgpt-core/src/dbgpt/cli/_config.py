"""User-level configuration management for the K-ICS CLI.
...
# need to be readable only by the owning user. The K-ICS home directory is
...
def _render_profile_toml(
    ...
    lines = [
        f"# K-ICS configuration — profile: {spec.name}",
